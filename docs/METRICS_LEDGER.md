...
| Next deliberate refresh | not started | n/a until run | n/a | The refresh procedure in `docs/RUNBOOK.md` is the metric: artifact diff against the replaced pin, dated PROVENANCE entry |
